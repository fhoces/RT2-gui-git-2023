...
subtitle: "RT2 Training"
date:  "`r format(as.Date('2023-05-18'), '%d %B %Y')` \\
[Slides](https://fhoces.github.io/RT2-gui-git-2023/)"
output: 
  xaringan::moon_reader:
    footer: "These slides available at https://fhoces.github.io/RT2-gui-git-2023/"
...
- We will work in pairs. Once you are done, help trouble shoot any problems of your teammate 
...
- Others hosting services include: Bitbucket, GitLab, Gitkraken, etc. 

- Other GUIs include: SourceTree, Gitkraken, RStudio.
...
pagedown::chrome_print("git-non-prog.html", output = "git-non-prog.pdf")
```