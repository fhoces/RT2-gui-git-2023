...
- **Remote:** whenever you make changes to the files in the cloud/server you are working remotely.   

### Actions to get files

- **Fork:** when in github.com you copy the repo of somebody else's account into your account, you fork it.     

- **Clone:** when you download a repo into your local machine, using the github app, you clone a repo.     
...
- Having problem with authentication?  --> Install the Github desktop app and login.   
